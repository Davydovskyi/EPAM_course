...
public class TreasureForAmountCommand implements Command {
	...
	public List<Treasure> excute(List<Treasure> treasures, String request) throws ServiceException {
		...
		service.getTreasures(treasures, Boolean.parseBoolean(params[1].split("=")[1]),
				Integer.parseInt(params[2].split("=")[1]));

		return service.getTreasuresForAmount(treasures, Integer.parseInt(params[3].split("=")[1]));
	}
}